                    ...
                    <div class="d-flex align-items-center justify-content-end">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">角色修改</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="needs-validation" novalidate action="{{route("admin.role.update",['id'=>$role->id])}}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="name" value="{{$role->name}}" class="form-control" id="validationCustomUsername" placeholder="请输入邮箱" aria-describedby="inputGroupPrepend" required>
                            ...
                            {{-- 选择给用户修改权限 --}}
                            <div class="card">
                                <h4 class="card-title">修改用户权限</h4>
                                @foreach($nodes_list as $v)
                                    <div class="custom-control custom-checkbox" style="margin-left: {{$v['level']*30}}px;">
                                        <input type="checkbox" @if(in_array($v['id'],$role_node)) checked @endif class="check_node" iid="{{$v['id']}}" pid="{{$v['pid']}}" value="{{$v['id']}}" name="node_ids[]" >
