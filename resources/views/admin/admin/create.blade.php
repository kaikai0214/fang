                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="needs-validation" novalidate action="{{route("admin.user.add")}}" method="post">
                                @csrf
                                <div class="form-row">
                                    <div class="col-md-4 mb-3">
                                        <label for="validationCustom01">账号</label>
                                        <input type="text" name="username" class="form-control" id="validationCustom01" placeholder="请输入您的账号" value="" required>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" name="truename" class="form-control" id="validationCustom02" placeholder="请输入真实实名" value="" required>
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                    </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" name="password" class="form-control" id="validationCustom04" placeholder="请输入密码" required>
                                        <div class="invalid-feedback">
                                            Please provide 密码.
                                        </div>
                                    </div>
