...
<head>
    <meta charset="utf-8">
    <meta name="author" content="朱登瀛">
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{Adminstatic()}}assets/images/favicon.png">
    <title>租房网后台管理系统</title>
    <!-- Custom CSS -->
    <link href="{{Adminstatic()}}assets/libs/chartist/dist/chartist.min.css" rel="stylesheet">
    <link href="{{Adminstatic()}}assets/extra-libs/c3/c3.min.css" rel="stylesheet">
    <link href="{{Adminstatic()}}assets/extra-libs/jvector/jquery-jvectormap-2.0.2.css" rel="stylesheet" />
    <!-- Custom CSS -->
    <link href="{{Adminstatic()}}dist/css/style.min.css" rel="stylesheet">
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="{{Adminstatic()}}assets/libs/jquery/dist/jquery.min.js"></script>
{{--    sweetalert --}}
                ...
                <div class="navbar-brand">
                    <a href="index.html" class="logo">
                        ...
                        <b class="logo-icon">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{{Adminstatic()}}assets/images/logo-icon.png" alt="homepage" class="dark-logo" />
                            <!-- Light Logo icon -->
                            <img src="{{Adminstatic()}}assets/images/logo-light-icon.png" alt="homepage" class="light-logo" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span class="logo-text">
                                <!-- dark Logo text -->
                                <img src="{{Adminstatic()}}assets/images/logo-text.png" alt="homepage" class="dark-logo" />
                            <!-- Light Logo text -->
                                <img src="{{Adminstatic()}}assets/images/logo-light-text.png" class="light-logo" alt="homepage" />
                            </span>
                    </a>
                ...
                <ul class="navbar-nav float-right">
                                ...
                                <li>
                                    <div class="message-center message-body">
                                        ...
                                        <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img">
                                                    <img src="{{Adminstatic()}}assets/images/users/1.jpg" alt="user" class="rounded-circle">
                                        ...
                                        <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img">
                                                    <img src="{{Adminstatic()}}assets/images/users/2.jpg" alt="user" class="rounded-circle">
                                        ...
                                        <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img">
                                                    <img src="{{Adminstatic()}}assets/images/users/3.jpg" alt="user" class="rounded-circle">
                                        ...
                                        <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img">
                                                    <img src="{{Adminstatic()}}assets/images/users/4.jpg" alt="user" class="rounded-circle">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img src="{{Adminstatic()}}assets/images/users/2.jpg" alt="user" class="rounded-circle" width="40">
                        ...
                        <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                            ...
                            <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                                <div class="">
                                    <img src="{{Adminstatic()}}assets/images/users/2.jpg" alt="user" class="rounded-circle" width="60">
                                </div>
                                <div class="m-l-10">
                                    <h4 class="m-b-0">{{session('info')['username']}}</h4>
                                    <p class=" m-b-0">{{session('info')['email']}}</p>
                                </div>
                            </div>
...
{{--                    用到的--}}
                        ...
                        <ul aria-expanded="false" class="collapse  first-level">
                            <li class="sidebar-item">
                                <a href="{{route('admin.user.index')}}" class="sidebar-link">
                                    ...
                                    <span class="hide-menu"> 用户列表 </span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                        ...
                        <ul aria-expanded="false" class="collapse  first-level">
                            <li class="sidebar-item">
                                <a href="{{route('admin.role.index')}}" class="sidebar-link">
                                    <i class="mdi mdi-adjust"></i>
                                    <span class="hide-menu"> 角色列表 </span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a href="{{route('admin.role.create')}}" class="sidebar-link">
                                    <i class="mdi mdi-format-align-right"></i>
                                    <span class="hide-menu"> 添加角色 </span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul aria-expanded="false" class="collapse  first-level">
                            <li class="sidebar-item">
                                <a href="{{route('admin.node.index')}}" class="sidebar-link">
                                    <i class="mdi mdi-adjust"></i>
                                    <span class="hide-menu"> 权限列表 </span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a href="{{route('admin.node.create')}}" class="sidebar-link">
                                    <i class="mdi mdi-format-align-right"></i>
                                    <span class="hide-menu"> 添加权限 </span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{Adminstatic()}}docs/documentation.html" aria-expanded="false">
        ...
        <div class="tab-content" id="pills-tabContent">
                    ...
                    <li>
                        <div class="message-center chat-scroll">
                            ...
                            <a href="javascript:void(0)" class="message-item" id='chat_user_5' data-user-id='5'>
                                    <span class="user-img">
                                        <img src="{{Adminstatic()}}assets/images/users/5.jpg" alt="user" class="rounded-circle">
                                        <span class="profile-status offline pull-right"></span>
                                    </span>
                                <div class="mail-contnet">
                            ...
                            <a href="javascript:void(0)" class="message-item" id='chat_user_6' data-user-id='6'>
                                    <span class="user-img">
                                        <img src="{{Adminstatic()}}assets/images/users/6.jpg" alt="user" class="rounded-circle">
                                        <span class="profile-status offline pull-right"></span>
                                    </span>
                                <div class="mail-contnet">
                            ...
                            <a href="javascript:void(0)" class="message-item" id='chat_user_7' data-user-id='7'>
                                    <span class="user-img">
                                        <img src="{{Adminstatic()}}assets/images/users/7.jpg" alt="user" class="rounded-circle">
                                        <span class="profile-status offline pull-right"></span>
                                    </span>
                                <div class="mail-contnet">
                                    <h5 class="message-title">Pavan kumar</h5>
                            ...
                            <a href="javascript:void(0)" class="message-item" id='chat_user_8' data-user-id='8'>
                                    <span class="user-img">
                                        <img src="{{Adminstatic()}}assets/images/users/8.jpg" alt="user" class="rounded-circle">
                                        <span class="profile-status offline pull-right"></span>
                                    </span>
                                <div class="mail-contnet">
            ...
            <div class="tab-pane fade p-15" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                ...
                <div class="steamline">
                    ...
                    <div class="sl-item">
                        <div class="sl-left">
                            <img class="rounded-circle" alt="user" src="{{Adminstatic()}}assets/images/users/2.jpg"> </div>
                        <div class="sl-right">
                    ...
                    <div class="sl-item">
                        <div class="sl-left">
                            <img class="rounded-circle" alt="user" src="{{Adminstatic()}}assets/images/users/1.jpg"> </div>
                        <div class="sl-right">
                            <div>
                    ...
                    <div class="sl-item">
                        <div class="sl-left">
                            <img class="rounded-circle" alt="user" src="{{Adminstatic()}}assets/images/users/4.jpg"> </div>
                        <div class="sl-right">
                            <div class="font-medium">Go to the Doctor
                                <span class="sl-date">5 minutes ago</span>
                            </div>
                    ...
                    <div class="sl-item">
                        <div class="sl-left">
                            <img class="rounded-circle" alt="user" src="{{Adminstatic()}}assets/images/users/6.jpg"> </div>
                        <div class="sl-right">
                            <div>
                                <a href="javascript:void(0)">Stephen</a>
                                <span class="sl-date">5 minutes ago</span>
...
<script src="{{Adminstatic()}}assets/libs/popper.js/dist/umd/popper.min.js"></script>
<script src="{{Adminstatic()}}assets/libs/bootstrap/dist/js/bootstrap.min.js"></script>
<!-- apps -->
<script src="{{Adminstatic()}}dist/js/app.min.js"></script>
<script src="{{Adminstatic()}}dist/js/app.init.js"></script>
<script src="{{Adminstatic()}}dist/js/app-style-switcher.js"></script>
<!-- slimscrollbar scrollbar JavaScript -->
<script src="{{Adminstatic()}}assets/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js"></script>
<script src="{{Adminstatic()}}assets/extra-libs/sparkline/sparkline.js"></script>
<!--Wave Effects -->
<script src="{{Adminstatic()}}dist/js/waves.js"></script>
<!--Menu sidebar -->
<script src="{{Adminstatic()}}dist/js/sidebarmenu.js"></script>
<!--Custom JavaScript -->
<script src="{{Adminstatic()}}dist/js/custom.min.js"></script>
<!--This page JavaScript -->
<!--chartis chart-->
<script src="{{Adminstatic()}}assets/libs/chartist/dist/chartist.min.js"></script>
<script src="{{Adminstatic()}}assets/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js"></script>
<!--c3 charts -->
<script src="{{Adminstatic()}}assets/extra-libs/c3/d3.min.js"></script>
<script src="{{Adminstatic()}}assets/extra-libs/c3/c3.min.js"></script>
<script src="{{Adminstatic()}}assets/extra-libs/jvector/jquery-jvectormap-2.0.2.min.js"></script>
<script src="{{Adminstatic()}}assets/extra-libs/jvector/jquery-jvectormap-world-mill-en.js"></script>
<script src="{{Adminstatic()}}dist/js/pages/dashboards/dashboard1.js"></script>
{{--<script src="{{Adminstatic()}}assets/libs/jquery/dist/jquery.min.js"></script>--}}
