...
<head>
    ...
    <link rel="stylesheet" href="{{Adminstatic()}}layui/css/layui.css" media="all"/>
    <link rel="stylesheet" href="{{Adminstatic()}}css/login.css" media="all"/>
    <style>
        /* 覆盖原框架样式 */
...
<div class="zyl_lofo_main">
    <fieldset class="layui-elem-field layui-field-title zyl_mar_02">
        <legend>欢迎登陆 - 登瀛先生管理平台</legend>
    </fieldset>
    <div class="layui-row layui-col-space15">
        <form class="layui-form zyl_pad_01" action="{{route('admin.login')}}" method="post">
            @csrf
            <div class="layui-col-sm12 layui-col-md12">
                <div class="layui-form-item">
                    <input type="text" name="username" lay-verify="required|userName" value="admin" autocomplete="off" placeholder="账号" class="layui-input">
                    <i class="layui-icon layui-icon-username zyl_lofo_icon"></i>
                </div>
            </div>
            <div class="layui-col-sm12 layui-col-md12">
                <div class="layui-form-item">
                    <input type="password" name="password" lay-verify="required|pass" value="admin" autocomplete="off" placeholder="密码" class="layui-input">
...
<!-- Layui Js -->
<script type="text/javascript" src="{{Adminstatic()}}layui/layui.js"></script>
<!-- Jqarticle Js -->
<script type="text/javascript" src="{{Adminstatic()}}assembly/jqarticle/jparticle.min.js"></script>
<!-- ZylVerificationCode Js-->
<script type="text/javascript" src="{{Adminstatic()}}assembly/zylVerificationCode/zylVerificationCode.js"></script>
<script>
